...
*
* Diese Klasse ist unter der �ffentlichen GNU Lizenz (GPL) ver�ffentlicht.
* Weiterver�ffentlichungen (auch in ver�nderter Form) sind f�r jedes Medium
* ausdr�cklich erlaubt, sofern diese Copyright-Klauseln �bernommen werden.
* Der Autor ist neugierig, in welchen Projekten seine Klasse zum Einsatz kommt,
* und freut sich �ber jede Email, welche ihn darauf hinweist.
*
* @version 1.5
...
class pet
{
    ...
    */
	 ...
	 * @access public
	 * @return void
	 * @param switch boolean TRUE oder FALSE f�r an oder aus
	 ...
	 * @access public
	 * @return string
	 * @desc liefert das Template zur�ck
	 */
	function get()
	{
		return $this->file;
	 ...
	 * @access private
	 * @return array
	 * @desc liefert den bisher via addContent gelieferten Content zur�ck
	 */
	function getContent()
	{
		return $this->content;
	 ...
	 * @access private
	 * @return string
	 * @param string string String, in welchem sich ein Loop befinden k�nnte
	 * @desc liefert den ersten Loop in $string zur�ck
	 */
	function getLoop($string)
	{
		...
		else
		{
			...
			while($subloop > 0)
			{
				...
				//Loop im Loop, ignoriere den n�chsten end loop Tag
	 ...
	 * @return string
	 * @param string string String, in welchem sich ein Loop befinden k�nnte
	 * @desc liefert den Namen des ersten Loops in $string zur�ck
	 */
	 ...
	 * @access public
	 * @return boolean
	 * @desc verarbeitet das Template: f�gt Content in Template ein
	 */
	function parse()
	{
		if(!$this->file)
	 ...
	 * @access private
	 * @return string
	 * @param string string String, in welchem sich Loops befinden k�nnten
	 ...
	 * @access private
	 * @return string
	 * @param content array assoziatives Array, muss nicht Content f�r alle Content Tags im String enthalten
	 * @param string string String, in welchem Content Tags enthalten sein k�nnten
